package com.groupsoftware.pontointeligente.repositories;
...
import com.groupsoftware.pontointeligente.enums.TipoEnum;
...
public class LancamentoRepositoryTest {
    ...
    private Funcionario obterDadosFuncionario(Empresa empresa) throws NoSuchAlgorithmException {
        ...
        funcionario.setNome("Luiz Alberto");
        funcionario.setPerfil(PerfilEnum.ROLE_USUARIO);
        funcionario.setSenha(PasswordUtils.gerarBCrypt("123456"));
        funcionario.setCpf("54378911100");
        funcionario.setEmail("luiz@trisoft.com.br");
    ...
    private Empresa obterDadosEmpresa() {
        ...
        empresa.setRazaoSocial("TRISOFT");
